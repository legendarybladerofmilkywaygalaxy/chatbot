...
function decideMessage(sender, text1){
	...
	if (text.includes("hi")){
		...
		sendText(sender, "sorry, Sriram is so lazy that he didnt programmed me completely ask him to completely program me. Note: please dont use capitals use only small letters")
	}
}
